...
class SecondMenu:
    def start_game_menu():
        ...
        # cursor_color = (100, 100, 100) # darker grey # CURRENTLY NOT USED
        ...
        while True:
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    # elif button_rect.collidepoint(event.pos):  # if start vs player game button is clicked
                        # start game vs player
                    # elif button_rect_2.collidepoint(event.pos):  # if start game vs computer button is clicked
